...
namespace App\Tests\Unit\Diary\Repository\Product;

use App\Diary\Repository\Product\ApiProductRepository;
use App\Diary\Repository\Product\GetOneProductInterface;
use PHPUnit\Framework\TestCase;
use Symfony\Contracts\HttpClient\HttpClientInterface;
use Symfony\Contracts\HttpClient\ResponseInterface;

/** @covers \App\Diary\Repository\Product\ApiProductRepository */
final class ApiProductRepositoryTest extends TestCase
{
    ...
    "item": {
        ...
        $client->expects($this->once())
            ->method('request')
            ->with('GET', 'http://web/api/products/' . $productId)
            ->willReturn($response);
